...
/*note that this is a function used to give box locations for the drawing of the box on the rendered image.*/
  ...
  onButtonSubmit=() => {/* calls the Clarifai API function on button press*/
    ...
    app.models.predict(
      ...
      this.state.input)
    .then(response => this.displayFaceBox(this.calculateFaceLocation(response))/*displays box calculated from Clarifai. Note response is the function called from Clarifai api*/
